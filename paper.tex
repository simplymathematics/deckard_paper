...
modular design, configuration-driven framework, and experimental
methodology are original to this paper. While the prior works outlined
in the Usage Section can be fully reproduced with this software, this
paper is the first to present the system as a cohesive method, fully
specified, documented, and intended for broad reuse.
